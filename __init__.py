"""ComfyUI V3 nodes for MOSS Transcribe Diarize by T8star-Aix."""
...
try:
    if __package__:
        ...
        _package_name = "_comfyui_moss_transcribe_diarize_t8_bootstrap"
        ...
        if _nodes is None:
            ...
            if _spec is None or _spec.loader is None:
                raise RuntimeError("Unable to load ComfyUI MOSS nodes.")
    ...
    async def comfy_entrypoint():
        raise RuntimeError(
            "comfy_api.latest is required; install this directory inside a current ComfyUI build."
